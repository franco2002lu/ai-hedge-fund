...
> Retrieve real-time series across all supported platforms without database dependency. This endpoint directly proxies external platform APIs and returns data immediately for maximum freshness.

## OpenAPI

````yaml openapi.json get /series
paths:
  path: /series
  method: get
  servers:
